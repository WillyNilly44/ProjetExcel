...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    console.log('📥 Received KPI data:', { month, week, maintenance_1, maintenance_2, incidents_1, incidents_2, business_impacted });
    ...
    console.log('✅ Dashboard entry added successfully:', { 
      month, 
      originalWeek: week,
